...
export default function AnalystNotifications() {
  ...
  const templates = useMemo(() => ({
    report_ready: "Report Ready: Your data analysis report is available.",
    data_quality: "Data Quality Alert: Inconsistencies detected in submitted data.",
    analysis_update: "Analysis Update: New insights available based on recent data.",
    model_change: "Model Change Notice: Analytical model parameters updated.",
    request_input: "Request for Input: Please confirm dataset selections.",
  }), []);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Analysis related communications</p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={cause} onValueChange={(v)=> { setCause(v); setPayload(p=>({ ...p, message: (templates as any)[v] || p.message })); }}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="data_quality">Data Quality Alert</SelectItem>
                      <SelectItem value="analysis_update">Analysis Update</SelectItem>
                      <SelectItem value="model_change">Model Change Notice</SelectItem>
                      <SelectItem value="request_input">Request for Input</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Analysis-related notices</CardDescription>
        </CardHeader>
        <CardContent>
