      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => navigate("/analyst/settings")}>Settings</DropdownMenuItem>
            <DropdownMenuSeparator />
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>You will need to login again to access your analyst portal.</AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
