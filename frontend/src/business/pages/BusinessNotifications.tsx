...
export default function BusinessNotifications() {
  ...
  const templates = useMemo(() => ({
    plan_update: "Plan Update: Subscription details have changed.",
    payment_received: "Payment Received: Your transaction was successful.",
    refund_processed: "Refund Processed: The amount has been credited.",
    billing_issue: "Billing Issue: We detected a problem with your recent payment.",
    promo_offer: "Special Offer: Limited-time discount on subscriptions.",
  }), []);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Business and payments communications</p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={cause} onValueChange={(v)=> { setCause(v); setPayload(p=>({ ...p, message: (templates as any)[v] || p.message })); }}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="promo_offer">Promotional Offer</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Business-related notices</CardDescription>
        </CardHeader>
        <CardContent>
