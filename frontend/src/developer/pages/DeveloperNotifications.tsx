...
export default function DeveloperNotifications() {
  ...
  const templates = useMemo(() => ({
    bug_fix: "Bug fixed: The issue has been resolved in the latest patch.",
    new_version: "New Version Released: Please review the changelog.",
    update_available: "Update Available: Upgrade to the latest version.",
    incident_resolved: "Incident Resolved: Services are back to normal.",
  }), []);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Updates, software bugs, and version releases</p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={cause} onValueChange={(v)=> { setCause(v); setPayload(p=>({ ...p, message: (templates as any)[v] || p.message })); }}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="new_version">New Version</SelectItem>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Developer-related notices</CardDescription>
        </CardHeader>
        <CardContent>
